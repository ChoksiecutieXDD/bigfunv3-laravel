...
<body class="text-gray-700 min-h-screen overflow-x-hidden bg-gray-50 font-[Poppins]">
    ...
    <!-- Top Navigation Bar from your old design -->
    <nav class="fixed top-0 left-0 w-full h-16 bg-white z-50 shadow-sm flex items-center justify-between px-6 border-b border-gray-100">
        ...
        <a href="{{ route('supervisor.calendar') }}" class="flex items-center gap-2 px-4 py-2 bg-[#9D686E] text-white rounded-xl font-bold shadow-md shadow-[#9D686E]/20 hover:opacity-90 transition text-xs uppercase tracking-wide">
