...
<body class="min-h-screen bg-[#F6F7FB] bg-[radial-gradient(1200px_600px_at_15%_-10%,rgba(158,107,115,.18),transparent_60%),radial-gradient(900px_500px_at_95%_10%,rgba(134,84,92,.14),transparent_55%)] text-text-main font-['Poppins'] w-full pb-12 overflow-x-hidden">
    ...
    <nav class="bg-white/90 backdrop-blur-md border-b border-gray-100 sticky top-0 z-30 shadow-sm transition-all duration-300">
        <div class="max-w-415 mx-auto px-4 md:px-8">
            <div class="flex items-center justify-between py-4 md:py-6">
                <!-- Left Section: Back Link & Title -->
                <div class="flex items-center gap-6">
                    <a href="{{ $backLink ?? '#' }}" wire:navigate class="group flex items-center justify-center p-3 rounded-2xl text-gray-400 hover:text-plum hover:bg-plum-light border border-transparent hover:border-plum/20 transition-all duration-400 shadow-sm hover:shadow-md" title="Go Back">
                    ...
                    <div class="flex flex-col">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="hidden sm:inline-block px-3 py-1 rounded-lg bg-plum-light text-plum text-[10px] font-bold uppercase border border-plum/10 tracking-widest">Profile</span>
                        </div>
                ...
                <div class="flex items-center gap-4">
                    <div class="hidden md:flex flex-col items-end">
                        ...
                        <span class="text-sm font-black text-plum">{{ auth()->user()->role ?: 'User' }}</span>
                    </div>
    ...
    <main class="max-w-415 mx-auto px-4 md:px-8 py-10 transition-all duration-300">
        {{ $slot }}
    </main>
