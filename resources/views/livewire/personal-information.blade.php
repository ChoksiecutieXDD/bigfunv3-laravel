    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
            ...
            <div class="lg:col-span-4 space-y-6 lg:sticky lg:top-32">
                <div class="bg-white border border-gray-100 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-gray-200/50 transition-all hover:shadow-gray-300/50">
                    <div class="h-32 bg-linear-to-br from-plum via-plum-dark to-[#6b3e45]"></div>
                    <div class="px-8 pb-10">
                        <div class="-mt-16 flex flex-col items-center gap-5">
                            <div class="w-32 h-32 rounded-4xl bg-white p-2 shadow-2xl shrink-0 z-10">
                                <div class="w-full h-full rounded-3xl bg-gray-900 text-white flex items-center justify-center text-5xl font-black shadow-inner">
                                    {{ $this->initials }}
                                </div>
                            </div>
                            <div class="w-full min-w-0 text-center">
                                <h2 class="text-2xl sm:text-3xl font-black text-gray-900 leading-tight wrap-break-word tracking-tight">
                ...
                <div class="hidden lg:block bg-plum rounded-[2.5rem] p-8 border border-plum/10 shadow-xl shadow-plum/20 relative overflow-hidden group transition-all duration-500 hover:scale-[1.02]">
            ...
            <div class="lg:col-span-8 space-y-8">
                ...
                <div class="bg-white border border-gray-100 rounded-[2.5rem] shadow-xl shadow-gray-200/40 overflow-hidden group transition-all">
                    <div class="px-8 py-8 border-b border-gray-50 flex items-center justify-between">
                        <div class="flex items-center gap-5">
                            <div class="w-14 h-14 rounded-2xl bg-plum-light text-plum flex items-center justify-center border border-plum/10 transform transition-transform group-hover:rotate-12">
                    ...
                    <form wire:submit="updateProfile" class="p-8 md:p-10">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                            <div class="space-y-2">
                                ...
                                <input type="text" wire:model="first_name" required class="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-gray-100 focus:bg-white focus:ring-4 focus:ring-plum/10 focus:border-plum outline-none transition-all font-bold text-gray-800 placeholder-gray-300">
                            </div>
                            <div class="space-y-2">
                                <label class="block text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Last Name</label>
                                <input type="text" wire:model="last_name" required class="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-gray-100 focus:bg-white focus:ring-4 focus:ring-plum/10 focus:border-plum outline-none transition-all font-bold text-gray-800 placeholder-gray-300">
                            </div>
                            <div class="space-y-2">
                                <label class="block text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Contact Number</label>
                                <input type="text" wire:model="contact_no" class="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-gray-100 focus:bg-white focus:ring-4 focus:ring-plum/10 focus:border-plum outline-none transition-all font-bold text-gray-800 placeholder-gray-300">
                            </div>
                            <div class="space-y-2 text-red-100">
                                ...
                                <div class="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-gray-100 text-plum font-black opacity-80 cursor-not-allowed select-none">
                                    {{ auth()->user()->role }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                            <div class="space-y-2">
                                ...
                                <input type="date" wire:model="birthday" class="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-gray-100 focus:bg-white focus:ring-4 focus:ring-plum/10 focus:border-plum outline-none transition-all font-bold text-gray-800 text-sm h-14.5">
                            </div>
                            <div class="space-y-2">
                                <label class="block text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Age</label>
                                <input type="number" wire:model="age" class="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-gray-100 focus:bg-white focus:ring-4 focus:ring-plum/10 focus:border-plum outline-none transition-all font-bold text-gray-800">
                            </div>
                            <div class="space-y-2">
                                <label class="block text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Gender</label>
                                <div class="relative">
                                    <select wire:model="gender" class="w-full pl-6 pr-12 py-4 rounded-2xl bg-gray-50 border border-gray-100 focus:bg-white focus:ring-4 focus:ring-plum/10 focus:border-plum outline-none transition-all font-bold text-gray-800 appearance-none cursor-pointer h-14.5">
                                    ...
                                    <div class="absolute inset-y-0 right-0 flex items-center px-5 pointer-events-none text-plum">
                        ...
                        <div class="mb-10 space-y-2">
                            ...
                            <textarea wire:model="address" rows="3" class="w-full px-6 py-5 rounded-4xl bg-gray-50 border border-gray-100 focus:bg-white focus:ring-4 focus:ring-plum/10 focus:border-plum outline-none transition-all font-bold text-gray-800 placeholder-gray-300 leading-normal resize-none"></textarea>
                        </div>

                        <div class="flex justify-end">
                            <button type="submit" class="group relative inline-flex items-center gap-3 bg-plum hover:bg-plum-dark text-white font-black py-5 px-10 rounded-2xl transition-all duration-300 shadow-2xl shadow-plum/40 hover:shadow-plum/60 hover:-translate-y-1 active:scale-95 overflow-hidden">
                ...
                <div class="bg-white border border-gray-100 rounded-[2.5rem] shadow-xl shadow-gray-200/40 overflow-hidden group">
                    <div class="px-8 py-8 border-b border-gray-50 flex items-center justify-between">
                        <div class="flex items-center gap-5">
                            <div class="w-14 h-14 rounded-2xl bg-plum-light text-plum flex items-center justify-center border border-plum/10 transform transition-transform group-hover:scale-110">
                    ...
                    <form wire:submit="changePassword" class="p-8 md:p-10">
                        ...
                        <div class="mb-8 p-5 rounded-3xl border bg-green-50 border-green-200 text-green-800 flex items-center gap-4 animate-in fade-in zoom-in duration-300">
                        ...
                        <div class="space-y-8">
                            <div x-data="{ show: false }" class="space-y-2">
                                ...
                                <div class="relative">
                                    <span class="absolute left-6 top-1/2 -translate-y-1/2 text-gray-400 flex items-center z-10 transition-colors group-focus-within:text-plum">
                                        <span class="material-symbols-rounded text-xl">password</span>
                                    </span>
                                    <input :type="show ? 'text' : 'password'" wire:model="current_password" required class="w-full pl-16 pr-14 py-4.5 rounded-2xl bg-gray-50 border border-gray-100 focus:bg-white focus:ring-4 focus:ring-plum/10 focus:border-plum outline-none transition-all font-bold text-gray-800">
                                    <button type="button" @click="show = !show" class="absolute right-5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-plum transition-colors p-2 z-10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div x-data="{ show: false }" class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input :type="show ? 'text' : 'password'" wire:model="new_password" required class="w-full pl-16 pr-14 py-4.5 rounded-2xl bg-gray-50 border border-gray-100 focus:bg-white focus:ring-4 focus:ring-plum/10 focus:border-plum outline-none transition-all font-bold text-gray-800">
                                        <button type="button" @click="show = !show" class="absolute right-5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-plum transition-colors p-2 z-10">
                                            <span class="material-symbols-rounded text-xl" x-text="show ? 'visibility_off' : 'visibility'"></span>
                                        </button>
                                    </div>
                                ...
                                <div x-data="{ show: false }" class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input :type="show ? 'text' : 'password'" wire:model="confirm_password" required class="w-full pl-16 pr-14 py-4.5 rounded-2xl bg-gray-50 border border-gray-100 focus:bg-white focus:ring-4 focus:ring-plum/10 focus:border-plum outline-none transition-all font-bold text-gray-800">
                                        <button type="button" @click="show = !show" class="absolute right-5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-plum transition-colors p-2 z-10">
                                            <span class="material-symbols-rounded text-xl" x-text="show ? 'visibility_off' : 'visibility'"></span>
                                        </button>
                                    </div>
