<div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-8"
    ...
    <section class="bg-white rounded-2xl sm:rounded-[2.5rem] shadow-xl shadow-black-200/50 border border-gray-100 overflow-hidden">
        ...
        <div class="overflow-x-auto custom-scrollbar">
                            ...
                            <td class="p-4 text-left align-top">
                                <div class="flex justify-start items-start h-full">
                                    <div class="flex flex-col gap-1 text-xs w-40">
                                        ...
                                        @if($isCard)
                                        <div class="mt-1 flex items-center gap-1.5 text-[9px] font-black text-[#9E6B73]/80 uppercase tracking-tighter bg-[#9E6B73]/5 px-2 py-0.5 rounded border border-[#9E6B73]/10">
                            ...
                            <td class="p-4 align-middle text-center w-48">
                                <div class="flex flex-col gap-2 w-full">
                                    <div class="flex items-stretch w-full border border-gray-200 rounded-lg overflow-hidden shadow-sm bg-white focus-within:border-[#9E6B73] focus-within:ring-1 transition-all"
                                        ...
                                        <button type="button" @click="confirmMessage = 'Are you sure you want to change the payment method? The balance due will be affected by this change (e.g. 2.9% surcharge for Card Holder).'; confirmAction = () => $wire.savePaymentType({{ $row->id }}, method); showConfirmModal = true;" class="bg-gray-50 hover:bg-[#9E6B73]/10 text-gray-500 hover:text-[#9E6B73] transition-colors border-l border-gray-200 px-2.5 flex items-center justify-center cursor-pointer">
            ...
            <div class="p-4 border-t border-gray-100 bg-[#9E6B73]/5 flex justify-between items-center">
                <span class="text-[10px] font-black text-[#9E6B73] uppercase tracking-widest px-3 py-1 bg-white rounded-full border border-[#9E6B73]/10 shadow-sm">
                    Showing {{ $pendingPayments->firstItem() }}-{{ $pendingPayments->lastItem() }} of {{ $pendingPayments->total() }}
                </span>
                <div class="flex gap-2">
                    <button wire:click="previousPage('page_pay')" @disabled($pendingPayments->onFirstPage()) class="p-2 rounded-xl bg-white border border-gray-200 text-gray-500 hover:text-[#9E6B73] hover:border-[#9E6B73]/30 transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-sm group">
                        <span class="material-symbols-rounded block group-hover:-translate-x-0.5 transition-transform">chevron_left</span>
                    </button>
                    <button wire:click="nextPage('page_pay')" @disabled(!$pendingPayments->hasMorePages()) class="p-2 rounded-xl bg-white border border-gray-200 text-gray-500 hover:text-[#9E6B73] hover:border-[#9E6B73]/30 transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-sm group">
    ...
    <section class="bg-white rounded-2xl sm:rounded-[2.5rem] shadow-xl shadow-black-200/50 border border-gray-100 overflow-hidden">
        ...
        <div class="overflow-x-auto custom-scrollbar">
            ...
            <div class="p-4 border-t border-gray-100 bg-[#9E6B73]/5 flex justify-between items-center">
                ...
                <div class="flex gap-2">
                    <button wire:click="previousPage('page_inv')" @disabled($invoices->onFirstPage()) class="p-2 rounded-xl bg-white border border-gray-200 text-gray-500 hover:text-[#9E6B73] hover:border-[#9E6B73]/30 transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-sm group">
                        <span class="material-symbols-rounded block group-hover:-translate-x-0.5 transition-transform">chevron_left</span>
                    </button>
                    <button wire:click="nextPage('page_inv')" @disabled(!$invoices->hasMorePages()) class="p-2 rounded-xl bg-white border border-gray-200 text-gray-500 hover:text-[#9E6B73] hover:border-[#9E6B73]/30 transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-sm group">
                        <span class="material-symbols-rounded block group-hover:translate-x-0.5 transition-transform">chevron_right</span>
                    </button>
                </div>
            </div>
    ...
    <section class="bg-white rounded-2xl sm:rounded-[2.5rem] shadow-xl shadow-black-200/50 border border-gray-100 overflow-hidden">
            ...
            <div class="min-w-[1000px] px-1">
                <table class="w-full text-left text-sm border-collapse relative">
                    ...
                    <tbody class="divide-y divide-gray-50 bg-white">
                        ...
                        <tr class="group hover:bg-gray-50 transition-colors">
                            <td class="p-4 align-top text-left">
                                <span class="text-[10px] font-black uppercase bg-[#9E6B73]/10 text-[#9E6B73] px-2 py-1 rounded border border-[#9E6B73]/20 shadow-sm">{{ \Carbon\Carbon::parse($ord->event_date)->format('M d, Y') }}</span>
                            </td>
        ...
        @if ($orders->hasPages())
        <div class="p-4 border-t border-gray-100 bg-[#9E6B73]/5 flex justify-between items-center text-xs">
            <span class="text-[10px] font-black text-[#9E6B73] uppercase tracking-widest px-3 py-1 bg-white rounded-full border border-[#9E6B73]/10 shadow-sm">
                Showing {{ $orders->firstItem() }}-{{ $orders->lastItem() }} of {{ $orders->total() }}
            </span>
            <div class="flex gap-2">
                <button wire:click="previousPage('page_ord')" @disabled($orders->onFirstPage()) class="p-2 rounded-xl bg-white border border-gray-200 text-gray-500 hover:text-[#9E6B73] hover:border-[#9E6B73]/30 transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-sm group">
                    <span class="material-symbols-rounded block group-hover:-translate-x-0.5 transition-transform">chevron_left</span>
                </button>
                <button wire:click="nextPage('page_ord')" @disabled(!$orders->hasMorePages()) class="p-2 rounded-xl bg-white border border-gray-200 text-gray-500 hover:text-[#9E6B73] hover:border-[#9E6B73]/30 transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-sm group">
                    <span class="material-symbols-rounded block group-hover:translate-x-0.5 transition-transform">chevron_right</span>
                </button>
            </div>
        </div>
    ...
    <section class="bg-white rounded-2xl sm:rounded-[2.5rem] shadow-xl shadow-black-200/50 border border-gray-100 overflow-hidden">
        ...
        <div class="p-4 border-t border-gray-100 bg-[#9E6B73]/5 flex justify-between items-center text-xs">
            ...
            <div class="flex gap-2">
                <button wire:click="previousPage('page_deb')" @disabled($debtors->onFirstPage()) class="p-2 rounded-xl bg-white border border-gray-200 text-gray-500 hover:text-[#9E6B73] hover:border-[#9E6B73]/30 transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-sm group">
                    <span class="material-symbols-rounded block group-hover:-translate-x-0.5 transition-transform">chevron_left</span>
                </button>
                <button wire:click="nextPage('page_deb')" @disabled(!$debtors->hasMorePages()) class="p-2 rounded-xl bg-white border border-gray-200 text-gray-500 hover:text-[#9E6B73] hover:border-[#9E6B73]/30 transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-sm group">
                    <span class="material-symbols-rounded block group-hover:translate-x-0.5 transition-transform">chevron_right</span>
                </button>
            </div>
        </div>
    ...
    <section class="bg-white rounded-2xl sm:rounded-[2.5rem] shadow-xl shadow-black-200/50 border border-gray-100 overflow-hidden">
        ...
        <div class="p-4 border-t border-gray-100 bg-[#9E6B73]/5 flex justify-between items-center text-xs">
            ...
            <div class="flex gap-2">
                <button wire:click="previousPage('page_op')" @disabled($operators->onFirstPage()) class="p-2 rounded-xl bg-white border border-gray-200 text-gray-500 hover:text-[#9E6B73] hover:border-[#9E6B73]/30 transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-sm group">
                    <span class="material-symbols-rounded block group-hover:-translate-x-0.5 transition-transform">chevron_left</span>
                </button>
                <button wire:click="nextPage('page_op')" @disabled(!$operators->hasMorePages()) class="p-2 rounded-xl bg-white border border-gray-200 text-gray-500 hover:text-[#9E6B73] hover:border-[#9E6B73]/30 transition-all disabled:opacity-30 disabled:cursor-not-allowed shadow-sm group">
                    <span class="material-symbols-rounded block group-hover:translate-x-0.5 transition-transform">chevron_right</span>
                </button>
            </div>
        </div>
                        ...
                        <div class="grid grid-cols-1 gap-8">
                            ...
                            <div class="p-8 bg-slate-50 rounded-[24px] border border-dashed border-slate-200 gap-6 grid grid-cols-1 animate-[fadeIn_0.3s_ease-out]">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" wire:model="pay_card_holder" class="w-full px-5 py-3.5 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#9D686E]/20 outline-none text-sm font-black text-slate-800" placeholder="Full Name on Card">
                                </div>
                                <div class="input-group">
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" wire:model="pay_ref" placeholder="Enter Reference" class="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-xl focus:bg-white focus:border-[#9D686E]/30 outline-none text-[13px] font-bold text-slate-700 font-mono transition-all">
                                </div>
                            </div>

                            <div class="input-group">
                                <label class="block text-[11px] font-black text-slate-400 mb-3 uppercase tracking-widest">Internal Notes</label>
                                <textarea wire:model="pay_notes" rows="3" class="w-full px-6 py-5 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:border-[#9D686E]/30 outline-none text-[13px] font-medium text-slate-700 resize-none transition-all placeholder:text-slate-300" placeholder="Add payment notes..."></textarea>
                            </div>
                        </div>
                ...
                <div class="p-8 overflow-y-auto custom-scrollbar flex-grow bg-white">
                    <form wire:submit.prevent="sendEmail" class="space-y-8">
                        ...
                        <div class="input-group">
                            ...
                            <textarea wire:model="email_body" rows="12" class="w-full p-8 bg-slate-50 border border-slate-100 rounded-[24px] focus:bg-white focus:border-[#9D686E]/30 outline-none text-[14px] font-medium leading-relaxed resize-none transition-all custom-scrollbar" placeholder="Enter email content..."></textarea>
                        </div>
    ...
    <template x-teleport="body">
        ...
        <div x-show="showSuccessModal" class="fixed inset-0 z-[10001] flex items-center justify-center p-4" x-cloak>
            ...
            <div x-show="showSuccessModal"
                ...
                <button type="button" @click="showSuccessModal = false" class="w-full py-5 bg-slate-900 text-white rounded-[24px] font-black hover:bg-slate-800 transition shadow-xl shadow-slate-900/20 uppercase tracking-[0.2em] text-[11px] active:scale-[0.98]">Continue</button>
            </div>
        </div>
    </template>
    ...
    <template x-teleport="body">
        ...
        <div x-show="showPaymentSuccessModal" class="fixed inset-0 z-[10001] flex items-center justify-center p-6 sm:p-12 lg:p-20" x-cloak>
            ...
            <div x-show="showPaymentSuccessModal"
                ...
                <button type="button" @click="showPaymentSuccessModal = false" class="w-full py-5 bg-slate-900 text-white rounded-[24px] font-black hover:bg-slate-800 transition shadow-xl shadow-slate-900/20 uppercase tracking-[0.2em] text-[11px] active:scale-[0.98]">Great, Thanks!</button>
            </div>
        </div>
    </template>
    ...
    <template x-teleport="body">
        ...
        <div x-show="sentSuccessModal" class="fixed inset-0 z-[10001] flex items-center justify-center p-6 sm:p-12 lg:p-20" x-cloak>
            ...
            <div x-show="sentSuccessModal"
                ...
                <button @click="sentSuccessModal = false; $wire.resetEmailState()" class="w-full py-5 bg-[#9D686E] text-white rounded-[24px] font-black hover:bg-[#855359] shadow-xl shadow-[#9D686E]/20 transition-all active:scale-95 uppercase tracking-[0.2em] text-[11px]">Dismiss</button>
            </div>
        </div>
    </template>
    ...
    <template x-teleport="body">
        <div x-show="quotaLimitModal" class="fixed inset-0 z-[10001] flex items-center justify-center p-4" x-cloak>
            ...
            <div x-show="quotaLimitModal"
                ...
                <button @click="quotaLimitModal = false" class="w-full py-5 bg-slate-900 text-white rounded-[24px] font-black hover:bg-slate-800 transition shadow-xl shadow-slate-900/20 uppercase tracking-[0.2em] text-[11px] active:scale-[0.98]">Close</button>
            </div>
        </div>
    </template>
