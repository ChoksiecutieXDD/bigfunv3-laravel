<div class="max-w-200 mx-auto py-10 px-5 w-full">
    ...
    <a href="/admin/staff" wire:navigate class="inline-flex items-center gap-2 text-slate-500 font-semibold mb-5 transition-colors duration-200 no-underline bg-slate-100 px-4 py-2 rounded-xl hover:text-slate-800 hover:bg-slate-200 w-max">
