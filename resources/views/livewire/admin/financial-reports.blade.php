<div class="max-w-360 mx-auto w-full space-y-6 pb-12">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div class="flex flex-wrap md:flex-nowrap gap-2 bg-gray-100 p-1 rounded-xl items-center">
            ...
            <div class="gap-2 items-center mr-2 transition-all duration-300 {{ $period === 'custom' ? 'flex' : 'hidden' }}">
                <input type="date" wire:model="customStart" class="bg-white text-gray-700 text-sm px-2 py-2 rounded-lg border-none focus:ring-2 focus:ring-plum h-10 shadow-sm">
                <span class="text-gray-400 font-bold">-</span>
                <input type="date" wire:model="customEnd" class="bg-white text-gray-700 text-sm px-2 py-2 rounded-lg border-none focus:ring-2 focus:ring-plum h-10 shadow-sm">
            ...
            <select wire:model.live="period" class="bg-white text-gray-700 text-sm font-bold px-4 py-2 rounded-lg border-none focus:ring-2 focus:ring-plum cursor-pointer hover:bg-white transition h-10 shadow-sm">
    ...
    <div class="bg-white rounded-4xl shadow-lg border border-gray-100 overflow-hidden"
        ...
        <div class="p-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
            <h3 class="font-bold text-text-main flex items-center gap-2"><span class="material-symbols-rounded text-gray-400">receipt_long</span> All Transactions</h3>
    ...
    <div class="bg-white rounded-4xl shadow-lg border border-gray-100 overflow-hidden mt-6"
                ...
                <tbody class="text-sm divide-y divide-gray-50">
                    <template x-for="c in items.slice((page - 1) * perPage, page * perPage)" :key="c.id">
                        <tr class="hover:bg-red-50/30 transition">
                            ...
                            <td class="px-6 py-4 text-center"><a :href="'/admin/bookings/overview/' + c.id" class="text-xs font-bold text-blue-500 hover:underline">View</a></td>
                        </tr>
                    </template>
                    <tr x-show="items.length === 0">
