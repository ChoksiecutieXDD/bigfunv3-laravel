...
<body class="bg-[var(--color-bg-page)] text-[var(--color-text-main)] antialiased min-h-screen flex items-center justify-center selection:bg-[var(--color-plum)] selection:text-[var(--color-plum-light)]">
    ...
    <div
        ...
        <!-- Decorative Warning Icon / Dots -->
        <div class="mt-6 flex justify-center space-x-3">
            <div class="w-3.5 h-3.5 rounded-full bg-red-400 animate-pulse"></div>
            <div class="w-3.5 h-3.5 rounded-full bg-red-500 animate-pulse" style="animation-delay: 0.15s;"></div>
            <div class="w-3.5 h-3.5 rounded-full bg-red-600 animate-pulse" style="animation-delay: 0.3s;"></div>
        </div>

        <!-- Copy -->
        <h2 class="mt-8 text-3xl md:text-4xl font-bold tracking-tight">Something went wrong.</h2>
        <p class="mt-4 text-lg font-medium text-[var(--color-text-main)] opacity-75 max-w-md mx-auto">
            We've encountered a technical issue on our end. Our team has been notified and we're working to fix it.
        </p>
