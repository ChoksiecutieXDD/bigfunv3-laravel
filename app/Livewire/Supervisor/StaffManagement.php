...
class StaffManagement extends Component
{
    ...
    public function addStaff()
    {
        ...
        User::create([
            ...
            'email' => $this->email,
            'password_hash' => Hash::make('BigFun2025'), // FIXED: Matches your model
            'role' => $this->role,
    ...
    public function loadEditStaff($id)
    {
        ...
        $this->edit_id = $user->user_id; // FIXED: Use custom primary key
    ...
    public function updateStaff()
    {
        $this->validate([
            ...
            // FIXED: Added ,user_id so Laravel knows which column is the primary key for the unique check
    ...
    {
        // Auth::id() automatically grabs 'user_id' because of your primaryKey override.
        // Using the facade (\Illuminate\Support\Facades\Auth) clears up the IDE warnings.
    ...
    {
        // Fetch fresh data every render to prevent Collection serialization crashes
        ...
        return view('livewire.supervisor.staff-management', [
            'users' => $users
        ]);
    }
}
